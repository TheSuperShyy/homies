...
**ההיסוס עצמו הוא מה שמתייחסים אליו**, לא התקלה: שאין דבר קטן מדי, ושזה
נשאר בינו לבין הצוות. **ואז אתה עושה את הצעד ושואל שאלה צרה**, לא מזמין
אותו לספר:

אין מה להתלבט, גם דברים קטנים זה בדיוק מה שאנחנו כאן בשבילו, וזה נשאר
בינינו לבין הצוות. זה משהו בדירה, או משהו בשטח המשותף?

זאת דוגמה ולא נוסח קבוע. מה שתמיד שם: **שההיסוס נשמע**, **שהמחיר יורד**,
ו**שאלה שאפשר לענות עליה בשתי מילים**.
