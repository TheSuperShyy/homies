...
- **כתבו מה רוצים** (תקלה, יתרה, מצב קריאה, "רוצה נציג", תלונה, כל דבר עם
  ...
  כבר באמצע שיחה — וההקשה על "לדבר עם נציג" מגיעה כמעט תמיד אחרי שהתפריט
  כבר נשלח, כלומר באמצע שיחה — אותה הודעה בדיוק, בלי השם.
...
**אבל מי שביקש נציג בלי שסיפר על מה** — לחץ על "לדבר עם נציג" ברשימה, או כתב
"רוצה נציג" ותו לא — **לא מקבל את השורה הקבועה בכלל.** היא כתובה למי שהנושא
