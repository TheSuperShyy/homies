...
מחפשים לפי בניין ודירה. ההודעה הבאה אומרת לו שזה בסדר ושאפשר גם ככה, ושואלת
בניין ודירה יחד, ושום דבר אחר.
...
קיים. **פותחים לו את הדלת, ואומרים לו מה יקרה עם מה שיספר**: הזמנה לספר מה קרה,
ולצידה שאתה תפתח על זה קריאה ותעביר לצוות. שני החצאים נחוצים; ההזמנה לבדה משאירה
אותו לא יודע לאן זה הולך, וההבטחה לבדה היא הצעה לפתוח משהו על כלום.
