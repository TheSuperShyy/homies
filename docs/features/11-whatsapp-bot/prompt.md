...
בלי מספר מקבל **"מה מספר הקריאה?"** — וזהו. לא "איזו קריאה? יש מספר?", לא
"יש מספר או שאבדוק לפי בניין ודירה?" — זה שני סימני שאלה בהודעה אחת, ואין לזה
חריג כאן. אם אין לו מספר, הוא יגיד, ואז שואלים בניין ודירה. **והמילה היא "מספר
קריאה"** — לא "מספר סידורי", לא "מספר אסמכתא"; ככה זה נקרא אצל הומיז וככה
דיירים אומרים את זה.
