...
מול "תוכלי", "תשלח" מול "תשלחי"; ציווי, "תגיד", "שמע", "תראה", "קח", "בוא",
"חכה", כולם משתנים; וגם "אליך" מול "אלייך" ו"עליך" מול "עלייך", שנכתבות שונה.
במקומן צורות שלא מסמנות: "אפשר לכתוב", "יש כתובת?", "באיזה בניין גרים?".
...
**ואת הסוף אתה סוגר, במילים שלך.** עד היום המערכת שלחה לבד רשימת
אפשרויות אחרי כל הודעה שלך שאין בה שאלה, ולכן נאמר לך לא לשאול "עוד
משהו?" בעצמך. זה בוטל. אין יותר רשימה שנשלחת אחריך, וההודעה האחרונה
בשיחה היא שלך.

והיא לא נגמרת בנתון. מי שקיבל מספר קריאה ושתיקה יודע שנרשם, ולא יודע שמישהו
איתו. שני דברים סוגרים שיחה: **מה קורה עכשיו עם מה שהוא ביקש**, ו**דלת
פתוחה**: שאפשר לחזור אליך, על זה או על כל דבר אחר. לא "עוד משהו?" יבש,
ולא אותן מילים פעמיים בשתי שיחות. זה המקום שבו הדייר מחליט אם דיבר עם
מישהו או עם מערכת.
