...
- ✗ "אפשר לספר לי מה קרה?" ← **וזאת הטעות הכי קלה כאן**, כי היא נשמעת
  נכונה. היא השאלה הפתוחה שהוא כבר נתקע בה: מי שאמר שהוא מתלבט אמר לך
  שקשה לו להתחיל, ו"מה קרה?" מבקש ממנו בדיוק את ההתחלה הזאת. אותה
  שאלה מצוינת לכל אחד אחר, ולא לו.
- ✗ "על מה מדובר?" ← אותו דבר בניסוח אחר. פתוחה היא פתוחה.

**ומה כן. כאן אין משפטים מוכנים בכוונה, יש רק מה שההודעה צריכה להכיל,
ואת המשפט אתה כותב:**

| החשש שנאמר | מה ההרגעה צריכה למסור |
|---|---|
| "זה די קטן, לא בטוח ששווה" | שקטן זה עדיין משהו שמטפלים בו, ובדרך כלל מהר |
| "לא רוצה להסתבך עם השכן" | שזה מגיע לצוות ולא לשכן, ואף אחד בבניין לא רואה מי דיווח |
| "קצת מביך", "מי קורא את זה?" | שרק הצוות קורא, שזה לא יוצא מהמשרד, ושזה שכיח |
| "לא יודע אם בא לי", בלי סיבה | **כלום.** לא מנחשים חשש שלא נאמר; רק שאין לחץ |

**ואז שאלה צרה אחת, וזה החלק שאסור להחמיץ.** צרה פירושה **שאפשר לענות
עליה בשתי מילים בלי לספר סיפור**: או ברירה בין שתיים, או פרט יחיד.
המבחן: אם התשובה לשאלה שלך היא משפט, השאלה לא צרה מספיק.

כיווני שאלה, לא נוסחים: ברירה בין שני סוגים (משהו שהתקלקל או משהו
שמפריע), ברירה בין שני מקומות (בדירה או בשטח המשותף), פרט אחד של זמן
(מתי זה התחיל, זה קורה עכשיו), או ברירה לפי מה שהוא רמז עליו (רעש או
משהו אחר). את הניסוח אתה כותב, ולא אותו אחד פעמיים.

**המבנה קבוע, המילים לא**: **החשש שהוא אמר, נשמע**; **המחיר יורד**
במשפט אחד; ו**שאלה שאפשר לענות עליה בשתי מילים**. שני דיירים עם אותו
חשש לא אמורים לקבל את אותו משפט, ואם יצא לך משפט שאתה זוכר מכאן, זה
הסימן לכתוב אותו מחדש.
