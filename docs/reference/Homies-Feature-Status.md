...
During a call the agent can record that a payment link should go out. Nothing
delivers it yet.

**Waiting on:** a decision on who sends it — the management system offers no
way to generate the link automatically.
