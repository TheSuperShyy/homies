...
const S = {
  ...
  'voice.transcriptHint': { he: 'התחילו שיחה ודברו או כתבו למטה, והשיחה תופיע כאן.',
                            en: 'Start a call, then talk or type below. The conversation appears here.' },
  ...
  'voice.chatIdle':       { he: 'אפשר לכתוב לסוכן בזמן שיחה', en: 'Start a call to type to the agent' },
