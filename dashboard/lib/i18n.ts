...
const S = {
  ...
  'nav.voice':         { he: 'שיחת סוכן קולי',  en: 'Voice Agent call' },
  ...
  'voice.title':          { he: 'שיחת סוכן קולי', en: 'Voice Agent call' },
  'voice.tabIntake':      { he: 'קליטת פניות (מיכאל)', en: 'Inbound intake' },
  'voice.tabDebt':        { he: 'מעקב חובות', en: 'Debt follow-up' },
  'voice.who':            { he: 'למי מתקשרים', en: 'Who is being called' },
  'voice.source':         { he: 'נתוני אמת', en: 'Live data' },
  'voice.idle':           { he: 'מוכן', en: 'Idle' },
  'voice.connecting':     { he: 'מתחבר...', en: 'Connecting…' },
  'voice.live':           { he: 'בשיחה', en: 'Live' },
  'voice.start':          { he: 'התחלת שיחה', en: 'Start call' },
  'voice.hangup':         { he: 'ניתוק', en: 'Hang up' },
  'voice.mute':           { he: 'השתקת מיקרופון', en: 'Mute' },
  'voice.unmute':         { he: 'ביטול השתקה', en: 'Unmute' },
  'voice.agent':          { he: 'מיכאל', en: 'Michael' },
  'voice.you':            { he: 'אתם', en: 'You' },
  'voice.failed':         { he: 'השיחה לא הצליחה להתחיל. בדקו שהמיקרופון מאושר לדפדפן.',
                            en: 'The call could not start. Check the browser has microphone permission.' },
  'voice.micHint':        { he: 'שיחת אינטרנט מהדפדפן — המיקרופון נדרש.',
                            en: 'A web call from this browser — microphone required.' },
  'voice.transcriptHint': { he: 'התחילו שיחה ודברו, או כתבו למטה — השיחה תופיע כאן.',
                            en: 'Start a call and talk, or type below — the conversation appears here.' },
  'voice.told':           { he: 'מה הסוכן מקבל לפני השיחה', en: 'What the agent is told before it dials' },
  'voice.sample':         { he: 'נתוני דוגמה', en: 'Example data' },
  'voice.chatPlaceholder': { he: 'אפשר גם לכתוב לסוכן כאן…', en: 'Type a message to the agent…' },
  'voice.send':           { he: 'שליחה', en: 'Send' },
  'voice.chatFailed':     { he: 'ההודעה לא נשלחה. נסו שוב.', en: 'The message did not go through. Try again.' },
  'voice.card':           { he: 'כרטיס {n}', en: 'card {n}' },
  'voice.noCard':         { he: 'אין כרטיס', en: 'no card' },
  'voice.empty':          { he: 'אין כרגע חובות פתוחים להתקשר עליהם.', en: 'No open debts to call about right now.' },
  'voice.notConfigured':  { he: 'העמוד כבוי: חסרים משתני הסביבה של Vapi.', en: 'Switched off: the Vapi env values are not set.' },
