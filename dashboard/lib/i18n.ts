...
const S = {
  ...
  'calls.talk':           { he: 'לדבר עם מיכאל', en: 'Call Michael' },
  'calls.talkConnecting': { he: 'מתחבר...',        en: 'Connecting…' },
  'calls.talkHangup':     { he: 'ניתוק',           en: 'Hang up' },
  'calls.talkMute':       { he: 'השתקת מיקרופון', en: 'Mute' },
  'calls.talkUnmute':     { he: 'ביטול השתקה',     en: 'Unmute' },
  'calls.talkAgent':      { he: 'מיכאל',           en: 'Michael' },
  'calls.talkYou':        { he: 'אתם',             en: 'You' },
  'calls.talkFailed':     { he: 'השיחה לא הצליחה להתחיל. בדקו שהמיקרופון מאושר לדפדפן.',
                            en: 'The call could not start. Check the browser has microphone permission.' },
  'calls.talkMicHint':    { he: 'שיחת אינטרנט מהדפדפן — המיקרופון נדרש.',
