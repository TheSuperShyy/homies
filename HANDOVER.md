...
- **Emoji are a CLOSED CATEGORY: a face or a hand, never an object (17 Sep, epoch 41, LIVE).** 🙂 😊 🙏 👍 💪 🤝. Epoch 39 blacklisted a cockroach, a bulb and a tree, and the model answered a leak with a droplet; a blacklist grows forever. Held on five tempting probes. **If it drifts again, tighten the category — do not add a fourth banned picture.**
